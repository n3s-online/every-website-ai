...
11. You must include two following adverts. Make sure these adverts are formatted correctly and look very clean:
  ...
  - Advert to https://everywebsite.app (no logo)
    - The copy for this advert should indiciate that this page was generated by https://everywebsite.app and they can generate new pages by just changing the url
    - The advert (text) must link to https://everywebsite.app
